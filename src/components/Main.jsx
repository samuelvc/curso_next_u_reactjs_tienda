...
class Main extends React.Component {
		render() {
				if (this.state.progresostore) return ( < LoginPage errorLogin = ''
							progressLogin = {
								this.state.progresostore
							}
							/>);
							if (this.state.loginstore) {
								if (this.state.loginstore.loginMsg == 'Ok') return ( < DashPage / > );
								else return ( < LoginPage errorLogin = {
										this.state.loginstore.loginMsg
									}
									progressLogin = {
										false
									}
